...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt_contacto->execute()) {
        ...
        if ($stmt_usuario->execute()) {
            ...
            $sql_asociado = "UPDATE asociados SET nombre = :nombre, Apellido_Pat = :Apellido_Pat, Apellido_Mat = :Apellido_Mat, habilitado = :habilitado WHERE id_asociado = :id_asociado";
