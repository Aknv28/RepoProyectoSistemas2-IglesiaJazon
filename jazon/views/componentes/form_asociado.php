...
<body>
    ...
    <div class="mb-3">
        ...
        <small id="error_apellido_paterno" class="text-danger"></small>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="apellido_mat" id="apellido_mat" class="form-control" required
            ...
            <small id="error_apellido_materno" class="text-danger"></small>
    </div>

    <div class="mb-3">
        <label for="contacto" class="form-label">Teléfono</label>
        <input type="number" name="contacto" id="contacto" class="form-control" pattern="^[67][0-9]{7}$"
            ...
            <div id="error_telefono" class="text-danger mb-2"></div>
    </div>
